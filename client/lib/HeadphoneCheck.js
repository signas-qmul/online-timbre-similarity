...
(function(HeadphoneCheck, $, undefined) {
  ...
  HeadphoneCheck.renderHeadphoneCheckPage = function() {
    ...
    $('<div/>', {
      class: 'hc-instruction',
      html: '<p>Simply judge <em>which sound was softest</em> (quietest) — 1, 2, or 3?</p>'
    }).appendTo($('#hc-container'));
    $('<div/>', {
      class: 'hc-instruction',
  ...
  HeadphoneCheck.renderHeadphoneCheckCalibration = function() {
    ...
    $('<div/>', {
      class: 'hc-calibration-instruction',
      html: '<p>To start, you must calibrate your listening volume.</p>'
    }).appendTo($('#hc-container'));
    $('<div/>', {
      class: 'hc-calibration-instruction',
    ...
    $('<div/>', {
      class: 'hc-calibration-instruction',
      html: '<p>Then, press the "Play" button, and turn up the volume on your computer until the ' +
    ...
    $('<button/>', {
      ...
      text: 'Play',
    }).css('display', 'block').css('margin', 'auto').appendTo($('#hc-calibration-div'));
